...
type SelectProps = SingleSelectProps | MultiSelectProps | CreatableSelectProps | AsyncSelectProps;

declare const theReactSelect: React$1.ForwardRefExoticComponent<(SelectProps & React$1.HTMLAttributes<HTMLDivElement>) & React$1.RefAttributes<HTMLDivElement>>;
...
declare const optionVariants: (props?: ({
    ...
    state?: "default" | "selected" | "disabled" | null | undefined;
} & class_variance_authority_types.ClassProp) | undefined) => string;

export { type AsyncSelectProps, type CreatableSelectProps, type MultiSelectProps, theReactSelect as Select, type SelectGroup, type SelectOption, type SelectProps, type SingleSelectProps, cn, optionVariants, selectVariants };
